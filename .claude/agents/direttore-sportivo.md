...
- **Il debito aperto e' il tuo primo:** le **38 migrazioni** stanno nella cronologia di Supabase e **non nel repository**. Chi clona non ricrea il database, e il principio di ADR-002 resta disatteso. Costa poco — si esportano, non si riscrivono — e proprio per questo non ha scuse.
